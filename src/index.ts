...
import {soAltWieIch} from './songs/so-alt-wie-ich';
...
async function start() {
  ...
  const patchFactories = [soAltWieIch, sequenceDrums, pedalBaseNote, jam, test, young, wahrheit, system, diktator, liebtUns, endzeit];
